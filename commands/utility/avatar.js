  ...
  async execute(client, message, args, ee) {
    try {
      ...
      message.reply({ embeds:[new MessageEmbed()
        ...
        .addField("PNG",`[\`LINK\`](${member.displayAvatarURL({format: "png"})})`, true)
        .addField("JPEG",`[\`LINK\`](${member.displayAvatarURL({format: "jpg"})})`, true)
        .addField("WEBP",`[\`LINK\`](${member.displayAvatarURL({format: "webp"})})`, true)
        .setColor(ee.color)
